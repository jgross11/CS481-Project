...
class ChemicalProperties (var chemicalInformationID : Int, var formula : String, var name : String, var molarMass : Double, var density : Double, var isWaterSoluable : Boolean, var meltingPoint : Double, var boilingPoint : Double, var creatorID : Int, var Rating: Int){
    ...
    override fun toString() : String{
        ...
        return "$name: $formula | created by userid = $creatorID | id=$chemicalInformationID, mass = $molarMass, density=$density, watersoluble: $isWaterSoluable, gas @ ${boilingPoint}C, solid @ ${meltingPoint}C,  rating @ ${Rating} colors: ${colors.toString()}\n"
